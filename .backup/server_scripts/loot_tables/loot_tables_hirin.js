LootJS.lootTables((event) => {
	event
		...
		.createPool((pool) => {
			pool.addEntry(LootEntry.reference("foxes:artifacts/legalized_boots").withWeight(2))
			pool.addEntry(LootEntry.reference("foxes:artifacts/legalized_hats").withWeight(2))
			pool.addEntry(LootEntry.reference("foxes:artifacts/legalized_oddities").withWeight(2))

			pool.addEntry(LootEntry.empty().withWeight(114))
		})

	event
		.create("lootjs:medium_lootchest")
		.createPool((pool) => {
			...
			pool.addEntry(LootEntry.of("minecraft:leather_leggings").withWeight(10).setCount(1))
		...
		.createPool((pool) => {
			pool.addEntry(LootEntry.reference("foxes:artifacts/legalized_boots").withWeight(3))
			pool.addEntry(LootEntry.reference("foxes:artifacts/legalized_hats").withWeight(3))
			pool.addEntry(LootEntry.reference("foxes:artifacts/legalized_oddities").withWeight(3))

			pool.addEntry(LootEntry.empty().withWeight(191))

			pool.rolls(2)
		})

	event
		.create("lootjs:rare_lootchest")
		.createPool((pool) => {
			...
			pool.addEntry(LootEntry.of("minecraft:iron_leggings").withWeight(10).setCount(1))
		...
		.createPool((pool) => {
			...
			pool.addEntry(LootEntry.empty().withWeight(221))

			pool.rolls(3)
		})

	event
		.create("lootjs:epic_lootchest")
		.createPool((pool) => {
			...
			pool.addEntry(
				LootEntry.of("minecraft:iron_boots")
					.withWeight(10)
					.setCount(1)
					.enchant((builder) => {
			...
			pool.addEntry(
				LootEntry.of("minecraft:iron_leggings")
					.withWeight(10)
					.setCount(1)
					.enchant((builder) => {
						builder.withEnchantment("minecraft:protection", 1)
			...
			pool.addEntry(
				LootEntry.of("minecraft:iron_chestplate")
					.withWeight(10)
					.setCount(1)
					.enchant((builder) => {
						builder.withEnchantment("minecraft:protection", 1)
			...
			pool.addEntry(
				LootEntry.of("minecraft:iron_helmet")
					.withWeight(10)
					.setCount(1)
					.enchant((builder) => {
						builder.withEnchantment("minecraft:protection", 1)
		...
		.createPool((pool) => {
			...
			pool.addEntry(LootEntry.empty().withWeight(116))
